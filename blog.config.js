...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN',''  see /lib/lang.js for more.
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,telegram,messenger', // 分享的服務，按顺序显示,逗号隔开
